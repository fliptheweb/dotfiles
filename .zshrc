...
if [[ "$OSTYPE" == darwin* ]]; then
	...
	alias load-nginx='launchctl load -w ~/Library/LaunchAgents/homebrew.mxcl.nginx.plist'
	alias unload-nginx='launchctl unload ~/Library/LaunchAgents/homebrew.mxcl.nginx.plist'
